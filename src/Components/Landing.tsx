const Landing = () => {
    return (
        <div className='h-screen flex flex-col relative '>
            <div className='flex flex-col justify-center items-center absolute inset-0 mx-auto w-[100%]'>
            ...
            <div className='w-[90%] absolute bottom-0 md:gap-2 lg:gap-4 pb-4 md:pb-10 lg:pb-15 text-base'>
